...
export const optionBuy = (request, response) => {
  PortfolioController.optionBuy(request, response);
}

export const optionSell = (request, response) => {
  PortfolioController.optionSell(request, response);
}
